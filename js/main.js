$(function () {
    ...
    $(window).on("load scroll resize", function () {
        ...
        if (posY > graphic_targetY) {
            ...
            /*表示12_グラフィックのイラスト*/ $('#graphic_icon_img').addClass('graphic_icon_img_anime');
        }
        ...
        //UFOゆらゆら
        var UFO_posY = $(this).scrollTop();

        UFO_posY = UFO_posY - 50;

        var topPos = UFO_posY / 20 + 50;

        console.log('UFO_posY' + UFO_posY, 'topPos' + topPos);
